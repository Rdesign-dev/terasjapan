...
<body>
    <div class="container">
        ...
        <form id="registerForm" method="post" action="<?php echo base_url('register/registerProcess'); ?>"
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        <?php if($this->session->flashdata('error') && $this->session->flashdata('show_register')): ?>
