                        ...
                        <div class="administrator-table table-responsive">
                          <table class="table table-bordernone">
                            <tbody>
                              <tr>
                                <td>
                                  <div class="d-flex"><img class="img-fluid img-50 rounded-circle" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/admins.png" alt="">
     ...
     &lt;table class="table table-bordernone"&gt;
       &lt;tbody&gt;
         &lt;tr&gt;
           &lt;td&gt;
             &lt;div class="media"&gt;
               &lt;img class="img-fluid img-50 rounded-circle" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/admins.png" alt=""/&gt;
             &lt;div class="status-circle bg-primary"&gt; &lt;/div&gt;
                      ...
                      <div class="card-body">
                        <ul class="browser-used">
                          <li class="active">
                            ...
                            <div class="browser-box"><img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/chrom.png" alt=""></div>
                          </li>
                          <li>
                            <div class="brow-lable"><span>+60%</span><i class="fa fa-caret-down"></i></div>
                            <div class="browser-box"><img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/explorer.png" alt=""></div>
                          </li>
                          <li>
                            <div class="brow-lable"><span>+79%</span><i class="fa fa-caret-down"></i></div>
                            <div class="browser-box"><img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/safari.png" alt=""></div>
                          </li>
                          <li>
                            <div class="brow-lable"><span>+90%</span><i class="fa fa-caret-down"></i></div>
                            <div class="browser-box"><img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/opera.png" alt=""></div>
                          </li>
                        </ul>
                        <div class="code-box-copy">
     ...
     &lt;ul class="browser-used"&gt;
       &lt;li class="active"&gt;
         ...
         &lt;div class="browser-box"&gt;
           &lt;img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/chrom.png" alt="" /&gt;&lt;/div&gt;
       &lt;/li&gt;
       &lt;li&gt;
         &lt;div class="brow-lable"&gt;
           &lt;span&gt;+60%&lt;/span&gt;
         ...
         &lt;/div&gt;
         &lt;div class="browser-box"&gt;
           &lt;img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/explorer.png" alt="" /&gt;
         &lt;/div&gt;
       &lt;/li&gt;
       &lt;li&gt;
         &lt;div class="brow-lable"&gt;
         ...
         &lt;/div&gt;
         &lt;div class="browser-box"&gt;
           &lt;img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/safari.png" alt="" /&gt;&lt;/div&gt;
         &lt;/li&gt;
         &lt;li&gt;  
           ...
           &lt;/div&gt;
           &lt;div class="browser-box"&gt;
            &lt;img class="img-fluid" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/opera.png" alt="" /&gt;
          &lt;/div&gt;
        &lt;/li&gt;
    &lt;/ul&gt;
  &lt;/div&gt;
                    ...
                    <div class="bestselling-table table-responsive">
                      <table class="table table-bordernone">
                        <tbody>
                          <tr>
                            <td><span>01</span>
                              <div class="t-title ms-3"><img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/1.png" alt="">
                          ...
                          <tr>
                            <td><span>02</span>
                              <div class="t-title ms-3"><img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/2.png" alt="">
                          ...
                          <tr>
                            <td><span>03</span>
                              <div class="t-title ms-3"><img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/3.png" alt="">
                          ...
                          <tr>
                            <td><span>04</span>
                              <div class="t-title ms-3"><img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/4.png" alt="">
       ...
       &lt;table class="table table-bordernone"&gt;
         &lt;tbody&gt;
           &lt;tr&gt;
             &lt;td&gt;
               ...
               &lt;div class="t-title ms-3"&gt;
                 &lt;img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/1.png" alt="" /&gt;
           ...
           &lt;tr&gt;
             &lt;td&gt;&lt;span&gt;02&lt;/span&gt;
               &lt;div class="t-title ms-3"&gt;
                 &lt;img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/2.png" alt="" /&gt;
                 &lt;div class="d-inline-block align-middle"&gt;
           ...
           &lt;tr&gt;
             &lt;td&gt;&lt;span&gt;04&lt;/span&gt;
               &lt;div class="t-title ms-3"&gt;
                 &lt;img class="img-40 rounded-circle align-top" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/best-selling/4.png" alt="" /&gt;
                 &lt;div class="d-inline-block align-middle"&gt;
...
&lt;/div&gt;</code></pre>
              ...
              <div class="col-xl-3 col-lg-6 col-md-5 col-sm-6 box-col-3 our-city">
                <div class="card weather-sec">
                  ...
                  <div class="card-body weather-img"><img class="img-fluid bg-img-cover" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/weather.png" alt="">
...
&lt;div class="card-body weather-img"&gt;
  &lt;img class="img-fluid bg-img-cover" src="<?php echo base_url() ?>assets/vendor/envanto/assets/images/dashboard/weather.png" alt="" /&gt;
  &lt;div class="ag-snow"&gt;&lt;/div&gt;
&lt;/div&gt;
&lt;/div&gt;              </code></pre>
                    </div>
